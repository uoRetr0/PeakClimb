...
const Explore = () => {
  ...
  const classes = [
    ...
    },
    {
      ...
      timeOfDay: 'morning',
      day: 'saturday',
      description: 'Learn advanced lead climbing techniques with an experienced instructor.',
    },
    {
      title: 'Kids Climbing Camp',
      date: 'June 27, 2024',
      time: '1:00 PM - 3:00 PM',
      instructor: 'Nancy Green',
      level: 'beginner',
      timeOfDay: 'afternoon',
      day: 'sunday',
      description: 'A fun and educational climbing camp for kids aged 6-12. No prior experience needed.',
    },
    {
  ...
  const addToSchedule = (classItem) => {
    ...
    currentSchedule[classItem.day].push({ time: classItem.time, session: classItem.title });
    localStorage.setItem('schedule', JSON.stringify(currentSchedule));
    alert(`${classItem.title} added to your schedule on ${classItem.day} at ${classItem.time}`);
  };
      ...
      <div className="container mt-5">
        <div className="row">
          ...
          <div className="col-md-8">
            <h3>Available Classes and Events</h3>
            {filteredClasses.length > 0 ? (
              ...
              <p>No classes or events match your filters.</p>
            )}
          </div>
        </div>
      </div>
